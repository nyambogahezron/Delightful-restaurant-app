		...
		<section className='relative min-h-screen flex items-center overflow-hidden'>
			...
			<div className='max-w-7xl mx-auto w-full px-4 py-20 grid md:grid-cols-2 gap-12 items-center relative z-10'>
				...
				<div className='space-y-6'>
					<div className='text-accent text-sm font-semibold tracking-wide'>
						Best Prices Guaranteed
					</div>
					<h1 className='text-5xl md:text-6xl font-bold text-balance leading-tight'>
						Book Your <span className='text-accent'>Luxury Hotel</span> With
						Best Hotel <span className='text-accent'>Booking</span> Company,{' '}
						<span className='text-accent'>Delightful.</span>
					</h1>
					<p className='text-lg text-muted-foreground leading-relaxed'>
						Discover a sanctuary where sun-kissed shores meet timeless elegance.
						Our Beach Haven offers a serene escape infused with luxurious
						comfort and breathtaking natural beauty.
					</p>
				...
				<div className='relative h-96 md:h-full min-h-96'>
					<div className='absolute inset-0 bg-gradient-to-br from-accent/10 to-accent/5 rounded-3xl overflow-hidden'>
						<img
							src='https://picsum.photos/seed/luxury-room/1200/800'
